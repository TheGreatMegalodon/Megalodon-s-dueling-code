...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/TheGreatMegalodon/Megalodon-s-dueling-code/blob/main/Meg's%20Dueling%20Official.js"><img src="https://github.com/TheGreatMegalodon/Dueling-Component/blob/main/Dueling_Component/v1.3.6_Img.png" width="275" alt="Megalodon-s-dueling-code" /></a>
  </p>
</div>
...
- New features on the AFK checker (optimized)
...
- Created 2 new commands:
  ...
  - Wrap button that allows you to find players by teleporting to them.
- Added "Support message" when hosting.
- New game OBJ's.
- Removed 4 commands
   - gameover().
   - tpall
