...
To change a ship's ID you will need to go on the Ship Editor Website, for this click here:
...
[...]
  ...
  acceleration: [90,140]
```
 You will then start looking for the ship's `level` and the ship's `model`.
